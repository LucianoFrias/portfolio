...
import CannesIMG from '../..//img/cannes.jpg'
    ...
    <div className='centeredPage projectsPage'>
      ...
      <div className='projectsContainer'>
        ...
        <ProjectCard
          ...
          tools='JavaScript, React, LocalStorage API.'
        ...
        <ProjectCard
          title='Cannes Management System'
          description='An enterprise Resource Planning (ERP) software made for Cannes Hotel for accounting, procurement and billing.'
          tools='JavaScript, React, XAMPP, MySQL, DigitalPersona SDK'
          imageUrl={CannesIMG}
          color='Blue'
          githubURL="https://github.com/LucianoFrias/cannes-hotel-sistema"
        />
      </div>
